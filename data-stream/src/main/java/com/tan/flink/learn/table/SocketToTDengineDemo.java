 ...
 */
public class SocketToTDengineDemo {
    ...
    public static void main(String[] args) {
        ...
        tableEnv.executeSql("CREATE TABLE tdengine_table ( \n" +
                "    `user` STRING, \n" +
                "    `url` STRING, \n" +
                "    `ts` BIGINT\n" +
                "  ) WITH ( \n" +
                "    'connector' = 'jdbc', \n" +
                "    'url' = 'jdbc:TAOS-RS://192.168.136.100:6041/meiotds?batchErrorIgnore=true', \n" +
        ...
        tableEnv.executeSql("insert into tdengine_table SELECT `user`,`url`,`ts` from socket_info");
